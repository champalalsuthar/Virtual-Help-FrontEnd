...
const App = () => {
    ...
    useEffect(()=>{
      AOS.init({ offset: 20,});
      axios.get("https://cuh-virtual-help-backend.vercel.app/getNotes").then((data)=>{
...
(snapshot) => {
    ...
    // download url
      ...
      axios.post("https://cuh-virtual-help-backend.vercel.app/notes/upload",notes).then((res)=>
      {
    ...
    const SearchNotes = (e)=>{
      ...
      const Search  ={ Program:Program,
        ...
        Semester:Sem,
        Subject:Subject}
        axios.post("https://cuh-virtual-help-backend.vercel.app/notes/search" , Search).then((data)=>{
