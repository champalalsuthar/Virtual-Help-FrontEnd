...
const ForgetPassword = () => {
    ...
    const handelOTP =( e)=>{
        ...
        axios.post("https://cuh-virtual-help-backend.vercel.app/forgetPasswordOtp" ,RestPasswordFormData).then((res)=>{
    ...
    const handelRestPassword =(e)=>{
        e.preventDefault()
        axios.post("https://cuh-virtual-help-backend.vercel.app/resetPassword",RestPasswordFormData).then((res)=>
        {
            // alert(res.data.message);
            toast.info(res.data.message)
