...
export const Signup = () => {
    ...
    const handelOTP = (e) => {
        ...
        axios.post("https://cuh-virtual-help-backend.vercel.app/sendOtp", SignupFormData).then((res) => {
    ...
    const handelSignup = (e) => {
        e.preventDefault()
        axios.post("https://cuh-virtual-help-backend.vercel.app/Signup", SignupFormData).then((res) => {
