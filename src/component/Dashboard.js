...
const DeleteNotes = (ObjectId, filePath) => {
  ...
  axios.post("https://cuh-virtual-help-backend.vercel.app/deleteNotes", { ObjectId }).then((data) => {
    setTimeout(() => {
...
const DeletePyqs = (ObjectId, filePath) => {
  ...
  axios.post("https://cuh-virtual-help-backend.vercel.app/deletePyqs", { ObjectId }).then((data) => {
    setTimeout(() => {
      toast.success(data.data.message)
    }, 1);
  }).catch((err) => {
...
const DeleteBlog = (ObjectId, filePath) => {
  ...
  axios.post("https://cuh-virtual-help-backend.vercel.app/deleteBlog", { ObjectId }).then((data) => {
...
const Dashboard = () => {
  ...
  useEffect(() => {
    axios.get("https://cuh-virtual-help-backend.vercel.app/CheckLogin" ,{ withCredentials: true }).then((data) => {
    ...
    axios.get("https://cuh-virtual-help-backend.vercel.app/allData", { withCredentials: true, }).then((data) => {
  ...
  const logoutHandel = () => {
    axios.get("https://cuh-virtual-help-backend.vercel.app/logout").then((data) => {
